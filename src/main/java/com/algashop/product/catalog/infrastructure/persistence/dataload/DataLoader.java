package com.algashop.product.catalog.infrastructure.persistence.dataload;

import com.algashop.product.catalog.infrastructure.utility.AlgaShopResourceUtils;
...
public class DataLoader implements ApplicationRunner {
    ...
    private void importJsonFileToCollection(DataLoadProperties.DataLoadSources source) {
        ...
        List<Document> docs = parseJsonToDocument(rawJson);
